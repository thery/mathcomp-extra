...
Lemma lin_fib_alt n a b : lin_fib a b n.+2 = lin_fib a b n.+1 + lin_fib a b n.
Proof.
case: n a b =>//; elim => [//|n IHn] a b.
...
Proof.
by move: (coprimeSn n); rewrite /coprime gcdn_fib; move/eqP->.
Qed.
...
Proof. by elim: m => [|[|m] IH] //; rewrite lucasSS addn_gt0 IH. Qed.
...
Lemma fib_square n : 
  ((fib n) ^ 2)%nat = if odd n then (fib n.+1 * fib n.-1).+1
...
Proof.
elim: n {-2}n (leqnn n)=> [[] // _ |n IH]; first by rewrite big_ord0.
